...
ref_name_lst=[]
main_name=st.text_area(label='Enter Main Abstract:',height=200, max_chars=None, key=None)

#ref_name=st.text_area(label='Enter Reference Abstract:',height=200, max_chars=None, key=None)
